...
private AuthorRepository authorRepository;
    ...
    @ApiOperation( value  =  "Добавить или изменить автора книги,по айди книги",
            response = Author.class)
    @PutMapping("/{id}/addAuthors")
    public Author addBooks(@RequestBody Author author, @PathVariable long id) {
        return addBooks(author,id);
    }
